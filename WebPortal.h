...
<body>
    <div class="container">
        ...
        <p class="subtitle">Upload your books and documents</p>
        
        <div class="info">
            <strong>ℹ️ Instructions:</strong>
            <ul style="margin: 10px 0; padding-left: 20px;">
                <li>Upload .txt or .epub files</li>
                <li>Files will be saved to /books/ folder</li>
                <li>Maximum file size: 10MB</li>
                <li>Files uploaded: <span id="uploadCount">0</span></li>
            </ul>
        </div>
        ...
        <div class="upload-section">
            ...
            <form id="uploadForm" enctype="multipart/form-data">
                <input type="file" name="file" id="fileInput" accept=".txt,.epub" required>
                <br>
                <button type="submit">🚀 Upload to E-Reader</button>
            </form>
